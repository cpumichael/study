...
four. The same principle applies to the number nine,
which is written as IX. There are six instances where
subtraction is used:
...
def r2i(r):
    '''returns an integer representing the given roman numeral r'''
    r = r.upper()
    vals = dict(I=1, V=5, X=10, L=50, C=100, D=500, M=1000)
    dvals = dict(IV=4, IX=9, XL=40, XC=90, CD=400, CM=900)
